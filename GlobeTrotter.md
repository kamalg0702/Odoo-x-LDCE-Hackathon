...
?  Key Functionality/Components:
 ...
 Welcome message, list of recent trips, “Plan New Trip? button, recommended
...
?  Key Functionality/Components:
 ...
 “Add Stop? button, select city and travel dates, assign activities to each stop,
reorder cities.
...
?  Key Functionality/Components:
 ...
 Search bar, list of cities with meta info, “Add to Trip? button, filter by
country/region.
...
?  Key Functionality/Components:
 ...
 Public URL, itinerary summary, “Copy Trip? button, social media sharing, read-only
view.

12. User Pro?le / Settings Screen
